...
Running on ACTUAL user domains
"""
...
# Read actual domains from file
with open('/home/code/actual_domains.txt', 'r') as f:
    DOMAINS = [line.strip() for line in f if line.strip()][:500]
